...
\end{table}
Mediaausgaben bei bonprix werden meist in Kampagnen umgesetzt. Das heißt,  dass Media-Werbungen aktiviert werden, wenn andere Kanäle wie das Online-Marketing intensiviert werden. Für das Online-Marketing fallen täglich Kosten an. Anders als das Online-Marketing wird ein Media-Kanal nur für einen begrenzten Zeitraum wie einen Monat oder zwei Wochen hochgefahren.